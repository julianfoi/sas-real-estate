...
$insert = "INSERT INTO fotos (inmueble, descripcion, fecha) VALUES ('$inmueble', '$descripcion', '$today')";
...
echo "<div class='row'><div class='span12'><h2 class='center'>Foto subida exitosamente</h2><div class='message'><div id='alert'></div></div></div></div>"; 
//**end of inserted lines
}
}
?>  
	...
	<!-- ******** RESERVATION START ******** -->
		<div class="row">
			<div class="span12">
				<hr>
				<h2 class="center">Subir Fotos de Inmuebles</h2>
				<div class="message">
					<div id="alert"></div>
				</div>
			</div>
...
<form action='subirfot.php' method='POST' enctype='multipart/form-data' >
<div class="row">
<div class="span6">
<table>
<tbody>
...
<?php $inmueble = $_POST['inmueble']; 
echo "<input type='hidden' name='inmueble' value='".$inmueble."'>";
?>
