...
echo "
<li class='span3'><form action='subirfoto.php' method='POST'><input type='hidden' name='inmueble' value='".$opciones3['foto_id']."'><input type='submit' value='Subir Fotos'></form></br>
<img src='fotos/".$foto3.".jpg' alt='Gallery' class='round' /><img style='margin-bottom: 2%;' src='images/shadow3.png'>".$opciones3['tipo']." en ".$opciones3['lugar']."</li>";
